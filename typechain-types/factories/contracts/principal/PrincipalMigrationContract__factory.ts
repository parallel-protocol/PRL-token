...
type PrincipalMigrationContractConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
...
export class PrincipalMigrationContract__factory extends ContractFactory {
  ...
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(_mimo, _prl, _lockBox, _endpoint, _owner, overrides || {});
  }
  override deploy(
    _mimo: AddressLike,
    _prl: AddressLike,
    ...
    return super.deploy(_mimo, _prl, _lockBox, _endpoint, _owner, overrides || {}) as Promise<
      PrincipalMigrationContract & {
        deploymentTransaction(): ContractTransactionResponse;
      }
    >;
  }
  override connect(runner: ContractRunner | null): PrincipalMigrationContract__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): PrincipalMigrationContract {
    return new Contract(address, _abi, runner) as unknown as PrincipalMigrationContract;
  }
}
